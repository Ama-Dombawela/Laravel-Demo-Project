...
<template>
    ...
    <DashboardLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Payment Status</h2>
        </template>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center flex flex-col items-center">
                        ...
                        <Link href="/invoices" class="inline-block mt-6 px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                            Back to Invoices
                        </Link>
